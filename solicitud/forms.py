...
class SolicitudFrm(ModelForm):
	...
	domiciliopadre = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	direccionlaboralpadre = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	domiciliomadre = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	direccionlaboralmadre = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	domicilioconyugue = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	direccionlaboralconyugue = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' }), required=False, max_length=200)
	class Meta:
		model = Solicitud
		fields = '__all__'
		exclude = []
...
class ReferenciaFrm(ModelForm):
	direccion = forms.CharField( widget=forms.Textarea(attrs={'rows' : '3' , 'placeholder' : ''}), required=False)
	class Meta:
		model = Referencia
		fields = '__all__'
		exclude = []
...
class CuentaFrm(ModelForm):
	...
	numero_cuenta = forms.CharField(required=False, max_length= 100)
